...
/**
 * Class BW_Test_Order_Helper.
 */
class BW_Test_Order_Helper extends WC_Unit_Test_Case {
	...
	public function test_shipping_first_name() {
		...
		$this->assertEquals( Order_Helper::get_shipping_first_name( $order ), 'Jon' );
	}
	...
	public function test_shipping_last_name() {
		...
		$this->assertEquals( Order_Helper::get_shipping_last_name( $order ), 'Snow' );
	}
	...
	public function test_shipping_company() {
		...
		$this->assertEquals( Order_Helper::get_shipping_company( $order ), 'GoT' );
	}
	...
	public function test_shipping_address_1() {
		...
		$this->assertEquals( Order_Helper::get_shipping_address_1( $order ), 'House Stark' );
	}
	...
	public function test_shipping_address_2() {
		...
		$this->assertEquals( Order_Helper::get_shipping_address_2( $order ), 'Winterfell' );
	}
	...
	public function test_shipping_city() {
		...
		$this->assertEquals( Order_Helper::get_shipping_city( $order ), 'Paris' );
	}
	...
	public function test_shipping_state() {
		...
		$this->assertEquals( Order_Helper::get_shipping_state( $order ), '' );
	}
	...
	public function test_shipping_postcode() {
		...
		$this->assertEquals( Order_Helper::get_shipping_postcode( $order ), '75009' );
	}
	...
	public function test_shipping_country() {
		...
		$this->assertEquals( Order_Helper::get_shipping_country( $order ), 'FR' );
	}
	...
	public function test_billing_phone() {
		...
		$this->assertEquals( Order_Helper::get_billing_phone( $order ), '0612341234' );
	}
	...
	public function test_billing_email() {
		...
		$updated_order = new WC_Order( Order_Helper::get_id( $order ) );
		$this->assertEquals( Order_Helper::get_billing_email( $updated_order ), 'jsnow@boxtal.com' );
	}
}
