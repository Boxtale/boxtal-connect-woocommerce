<?php
/**
 * Contains code for customer helper class.
 *
...
class Customer_Helper {
     ...
     *
     * @param WC_Customer $customer woocommerce customer.
     * @param string $address_1 desired billing address 1.
     * @void.
     */
     ...
     *
     * @param WC_Customer $customer woocommerce customer.
     * @param string $address_2 desired billing address 2.
     * @void.
     */
